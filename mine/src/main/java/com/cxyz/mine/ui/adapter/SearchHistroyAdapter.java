...
public class SearchHistroyAdapter extends BaseRecycleViewAdapter<String, SearchHistroyAdapter.myHolder> {
    private Context context;
    private List<SearchHistory> histroyList;
    public SearchHistroyAdapter(Context context, List<SearchHistory> histroyList) {
        super(context);
