package com.cxyz.widget.datetime;
...
import com.cxyz.utils.date.Date;
...
public class DateTimeDialog extends Dialog {
    ...
    public static class DateBuilder{
        ...
        {
            return View.inflate(mContext, R.layout.common_dialog_date_layout,null);
        }
    ...
    public static class TimeBuilder{
        ...
        private View getContentView()
        {
            return View.inflate(mContext,R.layout.common_dialog_time_layout,null);
        }
