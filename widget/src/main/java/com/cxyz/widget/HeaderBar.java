...
public class HeaderBar extends LinearLayout implements View.OnClickListener {
    ...
    public HeaderBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initAttr(context.obtainStyledAttributes(attrs,R.styleable.HeaderBar));
        initView();
    }
    ...
    private void initView()
    {
        ...
        View v = View.inflate(getContext(), R.layout.common_views_header_bar_layout, this);
